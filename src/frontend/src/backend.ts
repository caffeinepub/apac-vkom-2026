...
export class Backend implements backendInterface {
    ...
    async claimPreAuthorizedAdmin(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.claimPreAuthorizedAdmin();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRegistrationsCsv(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getRegistrationsCsv();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async register(arg0: string, arg1: string, arg2: Array<string>): Promise<{
        __kind__: "ok";
        ok: null;
    } | {
        __kind__: "error";
